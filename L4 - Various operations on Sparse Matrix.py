# Performing Addition or Multiplication or Transpose or Displaying the Sparse Matrix
...
def multiplication_of_sparse_matrix():
    n = int(input('Enter the value of N in NxN matrix : '))
...
if m == 1:
    ...
    multiplication_of_sparse_matrix()
elif m == 3:
    transpose_of_matrix()
elif m == 4:
    n = int(input('Enter the value of N in NxN Matrix : '))
