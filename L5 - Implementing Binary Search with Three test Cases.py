#Implementing Binary Search with three suitable Search cases
...
#Test Case 1 : entering or passing the element that is not present in the array
print('Test case 1: ')
arr1 = [78,99,66,-99425,33,45]
s1 = -63
binary_Search(arr1,s1)
