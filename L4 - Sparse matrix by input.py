# inputing value of the matrix and converting it to Sparse matrix
print('''Venkatesh
121910313056''')
...
#Taking input funtion from the user
...
#Converting the input matrix representation into sparse matrix representation
